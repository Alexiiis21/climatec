      ...
      <div className="relative isolate pt-14 overflow-hidden">
        <MaxWidthWrapper className="mb-20 mt-20 sm:mt-28 flex flex-col items-center justify-center text-center">
          ...
          <h1 className="max-w-4xl text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight text-white drop-shadow-2xl">
            Nuestros <span className="bg-gradient-to-r from-[#e6a126] to-[#ffbe3d] bg-clip-text text-transparent">Servicios</span>
          </h1>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="lg:w-1/2 order-2 lg:order-1">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">
                  Climatización Eficiente y de <span className="bg-gradient-to-r from-[#e6a126] to-[#ffbe3d] bg-clip-text text-transparent">Calidad</span>
                </h2>
          ...
          <div className="mb-24">
            <div className="flex flex-col lg:flex-row-reverse gap-12 items-center">
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">
                  Paneles para <span className="bg-gradient-to-r from-[#e6a126] to-[#ffbe3d] bg-clip-text text-transparent">Muros y Cubiertas</span>
                </h2>
                <p className="text-lg text-white/80 mb-6">
          ...
          <div>
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="lg:w-1/2 order-2 lg:order-1">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">
                  Ventilación, <span className="bg-gradient-to-r from-[#e6a126] to-[#ffbe3d] bg-clip-text text-transparent">Extracción</span> y Refrigeración
                </h2>
                <p className="text-lg text-white/80 mb-6">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="md:w-2/3">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
                  ¿Necesita ayuda con su proyecto de <span className="text-[#e6a126]">climatización</span>?
                </h2>
